...
const Complaints = () => (
    <div>
        ...
        <p>{it.L('If the client would like to file a complaint about the Company’s service, the client can send the details related to the client’s complaint to the Company at [_1]compliance@binary.com[_2]. The Company will investigate the client’s enquiry and send the client a final response within 15 days from the date on which the complaint is received.', '<a href="mailto:compliance@binary.com">', '</a>')}</p>
